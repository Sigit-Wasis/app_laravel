...
<head>
	...
	<link rel="icon" type="{{ asset('admin/image/png') }}" sizes="96x96" href="{{ asset('admin/assets/img/favicon.png') }}">
</head>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="elements.html" class=""><i class="lnr lnr-code"></i> <span>Siswa</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
